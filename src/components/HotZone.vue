...
.hz-m-wrap .hz-m-area{  position: absolute;
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
    cursor: crosshair;}
    .hz-m-wrap  .hz-m-item{  position: absolute;display: block;}
        .hz-m-wrap  .hz-m-item:hover .hz-m-bridge{ display: block}
 .hz-m-wrap  .hz-m-item:hover .hz-m-info{ display: block}
 .hz-m-wrap .hz-m-info{
    display: none;
    position: absolute;
    padding: 5px 10px;
...
.hz-m-wrap .hz-u-link{color:#333}
.hz-m-wrap .hz-u-link:hover{ text-decoration: none;}
.hz-m-wrap .hz-m-box{
    position: relative;
    width: 100%;
    height: 100%;
...
.hz-m-wrap .hz-m-box:hover .hz-u-close{display: block} 
